...
export const projects: Project[] = [
  ...
  },
  {
    ...
    visibility: 'public',
    featured: true,
    cover: '/projects/marvel-portal-app.png',
    coverWidth: 1877,
    coverHeight: 971,
    tagline: {
      en: 'A Marvel characters portal built with React Hooks and the Marvel API.',
      pl: 'Portal postaci Marvela zbudowany na React Hooks i Marvel API.',
    },
    description: {
      en: 'A single-page app for browsing Marvel characters: a randomized "character of the day", a character list and detail panels with their comics — all powered by the Marvel REST API. Built to practice React Hooks, data fetching with loading and error states, and component composition. Deployed on Vercel.',
      pl: 'Aplikacja SPA do przeglądania postaci Marvela: losowa „postać dnia”, lista postaci i panele szczegółów z ich komiksami — wszystko w oparciu o Marvel REST API. Zbudowana, aby przećwiczyć React Hooks, pobieranie danych ze stanami ładowania i błędu oraz kompozycję komponentów. Wdrożona na Vercel.',
    },
    tags: [
      'React 18',
      'React Router v6',
    ...
    liveUrl: 'https://marvel-with-hooks-brown.vercel.app',
    githubUrl: 'https://github.com/mkrtchyantigran/marvel-with-hooks',
    screenshots: [],
  },
  {
    id: 'books-library',
    ...
    visibility: 'public',
    featured: true,
    cover: '/projects/books-library.png',
    coverWidth: 1912,
    coverHeight: 856,
    tagline: {
      en: 'A book library manager built with React and Redux.',
      pl: 'Menedżer biblioteki książek zbudowany na React i Redux.',
    },
    description: {
      en: 'A single-page app for managing a book collection: add and delete books, mark favorites, filter by title or author, and pull random books from an API. Application state is handled with Redux. Deployed on Vercel.',
      pl: 'Aplikacja SPA do zarządzania kolekcją książek: dodawanie i usuwanie książek, oznaczanie ulubionych, filtrowanie po tytule lub autorze oraz pobieranie losowych książek z API. Stan aplikacji obsługiwany przez Redux. Wdrożona na Vercel.',
    },
    tags: ['React', 'Redux Toolkit', 'JavaScript', 'REST API', 'Vercel'],
    liveUrl: 'https://books-library-react-redux.vercel.app',
    githubUrl: 'https://github.com/mkrtchyantigran/BooksLibrary-React-Redux',
    screenshots: [],
  },
  {
    id: 'shop-store',
    ...
    visibility: 'public',
    featured: true,
    cover: '/projects/shop-store.png',
    coverWidth: 1776,
    coverHeight: 985,
    tagline: {
      en: 'A Next.js e-commerce storefront for a furniture shop.',
      pl: 'Sklep e-commerce z meblami zbudowany na Next.js.',
    },
    description: {
      en: 'A modern e-commerce storefront: a product catalog with categories and search, product pages, a wishlist and a shopping cart. Built with Next.js and deployed on Vercel.',
      pl: 'Nowoczesny sklep e-commerce: katalog produktów z kategoriami i wyszukiwaniem, strony produktów, lista życzeń i koszyk. Zbudowany na Next.js i wdrożony na Vercel.',
    },
    tags: [
      'Next.js 16',
      'React 19',
    ...
    liveUrl: 'https://shop-store-next.vercel.app',
    githubUrl: 'https://github.com/mkrtchyantigran/shop-store-next',
    screenshots: [],
  },
  {
    id: 'taskflow',
